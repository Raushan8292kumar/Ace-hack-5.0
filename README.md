...
<h2>App Working<h2>
<br>
<h4>The application opens with a home page accessible to all users. Upon login, the app stores user details and generates a personalized profile page. Logged-in users gain full access to advanced features such as AI chat and document guidance, while limited functionality is available to users who do not log in.</h4>
